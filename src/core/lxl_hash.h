...
int		lxl_hash1_init(lxl_hash1_t *hash, lxl_uint_t nelts, lxl_hash_key_pt key);
/*void 	lxl_hash_clear(lxl_hash_t *hash);
void 	lxl_hash_destroy(lxl_hash_t *hash);*/
int 	lxl_hash1_add(lxl_hash1_t *hash, char *name, size_t len, void *value);
void   *lxl_hash1_del(lxl_hash1_t *hash, char *name, size_t len);
void   *lxl_hash1_find(lxl_hash1_t *hash, char *name, size_t len);
void  **lxl_hash1_addfind(lxl_hash1_t *hash, char *name, size_t len);
